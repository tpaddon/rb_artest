        ...
        (async function (e, t) {
            return await new Promise((function (t, a) {
                ...
                !function (e) {
                    ...
                    a.src = e.loading.logo.src,
                    a.alt = e.loading.logo.alt;
                    var n = document.createElement("span");
                    n.setAttribute("class", "loading-text"),
                    n.innerText = e.loading.loadingMessage,
                    t.appendChild(a),
                    t.appendChild(n);
                ...
                function (e) {
                    if (e) {
                        var t = document.createElement("div");
                        t.id = "stats",
                        t.className = "ui stats";
                        var a = document.createElement("div");
                        a.id = "stats1",
                        a.className = "stats-item";
                        var n = document.createElement("p");
                        n.className = "stats-item-title",
                        n.innerText = "Main",
                        a.appendChild(n),
                        t.appendChild(a);
                        var i = document.createElement("div");
                        i.id = "stats2",
                        i.className = "stats-item";
                        var o = document.createElement("p");
                        o.className = "stats-item-title",
                        o.innerText = "Worker",
                        i.appendChild(o),
                        t.appendChild(i);
                ...
                /*if (n) {
                    var l = new Stats;
                    l.showPanel(0),
                    document.getElementById("stats1").appendChild(l.dom);
                    var c = new Stats;
                    c.showPanel(0),
                    document.getElementById("stats2").appendChild(c.dom)
                }*/
                    ...
                    navigator.mediaDevices.getUserMedia(m).then((function (r) {
                            ...
                            s.addEventListener("loadedmetadata", (function () {
                                    ...
                                    function (e, n, i, o, r, d, s, l, c, m) {
                                        ...
                                        var B,
                                        I = function (e) {
                                            B = e ? JSON.parse(e.matrixGL_RH) : null
                                        },
                                        L = Date.now();
                                        function S() {
                                            M.fillStyle = "black",
                                            M.fillRect(0, 0, y, x),
                                            M.drawImage(i, 0, 0, u, p, b, T, E, w);
                                        ...
                                        U = function () {
                                            ...
                                            if (e - L, L = e, B) {
                                                c.visible = !0;
                                                for (var n = 0; n < 16; n++)
                                                    t.delta[n] = B[n] - t.interpolated[n], t.interpolated[n] = t.interpolated[n] + t.delta[n] / 24;
                                        ...
                                        u = o,
                                        p = r,
                                        f = 320 / Math.max(u, p / 3 * 4),
                                        g = /Android|mobile|iPad|iPhone/i.test(navigator.userAgent) ? window.outerWidth / o : 1,
                                        v = u * g,
                                        h = p * g,
                                        E = u * f,
                                        w = p * f,
                                        ...
                                        b = (y - E) / 2,
                                        T = (x - w) / 2,
                                        R.style.clientWidth = y + "px",
                                        R.style.clientHeight = x + "px",
                                        R.width = y,
                                        R.height = x,
                                        k.setSize(v, h),
                                        (C = new Worker(m.workerUrl)).postMessage({
                                            type: "load",
                                            pw: y,
                                            ph: x,
